...
TEST_F(TestPreprocess, test_length_filter) {
    ...
    ASSERT_FALSE(filter("123"));
    ASSERT_FALSE(filter("1234"));
    ASSERT_TRUE(filter("12345"));
    ASSERT_TRUE(filter("123456"));
    ASSERT_TRUE(filter("1234567"));
    ASSERT_TRUE(filter("12345678"));
    ASSERT_TRUE(filter("123456789"));
    ASSERT_TRUE(filter("123456789A"));
    ASSERT_FALSE(filter("123456789AB"));
}
...
TEST_F(TestPreprocess, test_space_replacer) {
    ...
    ASSERT_EQ(replacer("123"), "123");
    ASSERT_EQ(replacer("123 45"), "123 45");
    ASSERT_EQ(replacer("123　45"), "123 45");
}
